...
const faqs = [
  ...
  { q: "What's included in the free tier?", a: "Full access to Theme 1 (Markets and Market Failure), 3 AI tutor messages per day, and progress tracking. No card required." },
  ...
  { q: "How is the AI essay marker different from UpLearn's?", a: "It quotes your actual words back to you, handles graph and diagram questions (when you describe them), and gives specific, actionable feedback — not generic 'add more evaluation' advice." },
  ...
  { q: "How is this different from Seneca, PMT, or Save My Exams?", a: "Those are great free resources but don't give you AI essay marking, an AI tutor, adaptive review, or a structured course in order. EconAStar is the structured, AI-powered layer on top." },
