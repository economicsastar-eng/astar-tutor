...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39ad09cd-6456-4f17-9350-eef83c5098e1/id-preview-c06934e7--7c8bd82d-aafd-47f0-9c5d-d7f8808aa73b.lovable.app-1780947330607.png" },
    ],
    links: [
...
function RootComponent() {
  ...
  useEffect(() => {
    void import("../lib/auth-persistence").then((m) => m.enforceSessionPersistence());
  }, []);
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <HeadContent />
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-GQW0WCV3SS"></script>
        <script dangerouslySetInnerHTML={{ __html: `
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
          gtag('config', 'G-GQW0WCV3SS');
        ` }} />
      </head>
      <body>
        {children}
